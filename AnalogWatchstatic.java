class AnalogWatchstatic{
static String brandName = "fastrack";
static String series = "fk exclusive";
static String strapColor = " black";
static int waterResistanceDepth = 50;
static String warrentyPeriod = "2 years";
static int price = 3149;
